...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <Skeleton
        className={cn("h-4 flex-1 max-w-[--skeleton-width]", state === "collapsed" && "hidden")}
